...
import { LayoutDashboard, List, PlusCircle, Star, Radar, Users, Settings, Menu, X, ExternalLink, ScanSearch, Search, Coins, ShieldCheck, Flag } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Credit usage', href: '/admin/credit-usage', icon: Coins },
