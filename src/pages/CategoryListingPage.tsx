...
const categoryConfig: Record<string, {
  ...
  Grants: {
    ...
    seoDescription: "Discover grants, scholarships, and funding opportunities available to young Victorians aged 15–25.",
    slug: 'grants',
  },
  Programs: {
    label: 'Programs',
    heading: 'Programs and courses',
    subtext: 'Youth programs, workshops, and development opportunities',
  ...
  Wellbeing: {
    ...
    seoDescription: "Find wellbeing resources, mental health support, and services for young Victorians aged 15–25.",
    slug: 'wellbeing',
  },
};
